...
class AtlasPaths:
    ...
    def __init__(self, lakehouse_root: Path | str, checkpoint_root: Path | str,
                 quarantine_root: Path | str, snapshot_root: Path | str) :
    ...
    def snapshot_path(self, domain: str) -> str:
        """Return the snapshot path for the specified domain."""
        return self._join_path(self._snapshot_root, domain,)

    def reconciliation_path(self,domain: str,sub_domain: str,dataset: str,) -> str:
        """Return the reconciliation path for the specified domain."""
        return self._join_path(self._lakehouse_root, "ops","reconciliation",domain,
                               sub_domain, dataset)
